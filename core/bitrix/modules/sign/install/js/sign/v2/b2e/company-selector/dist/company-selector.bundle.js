...
(function (exports,main_core,main_date,main_loader,main_popup,sign_v2_api,sign_v2_companyEditor,sign_v2_helper,sign_v2_b2e_schemeSelector,ui_entitySelector,sign_tour,ui_label,ui_alerts) {
	...
	var _selectCompany = /*#__PURE__*/babelHelpers.classPrivateFieldLooseKey("selectCompany");
	...
	class CompanySelector {
	  constructor(options) {
	    ...
	    Object.defineProperty(this, _selectCompany, {
	      value: _selectCompany2
	    });
	  ...
	  getLayout() {
		...
		`), main_core.Loc.getMessage('SIGN_B2E_COMPANIES_CHANGE_INN'));
		...
		`), babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].info.title.header.name, babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].info.title.header.dropdownButton);
		...
		`), babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].select.container, babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].info.container);
	    return babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].container;
	  }
	  getSelectedCompanyProvider() {
	    var _babelHelpers$classPr;
	    return (_babelHelpers$classPr = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].provider) != null ? _babelHelpers$classPr : null;
	  }
	  getCompanyId() {
	    var _babelHelpers$classPr2;
	    return (_babelHelpers$classPr2 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company]) == null ? void 0 : _babelHelpers$classPr2.id;
	  }
	  validate() {
	    ...
	    const isCompanyValid = main_core.Type.isInteger(babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].id) && babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].id > 0;
	...
	function _load2() {
	  ...
	  return babelHelpers.classPrivateFieldLooseBase(this, _api)[_api].loadB2eCompanyList().then(data => {
	    ...
	    if (main_core.Type.isObject(data.companies) && main_core.Type.isArray(data.companies)) {
	      ...
	      babelHelpers.classPrivateFieldLooseBase(this, _showTaxId)[_showTaxId] = Boolean(data == null ? void 0 : data.showTaxId);
	      babelHelpers.classPrivateFieldLooseBase(this, _updateDialogItems)[_updateDialogItems]();
	    }
	  }).catch(response => {
	    babelHelpers.classPrivateFieldLooseBase(this, _hideLoader)[_hideLoader]();
	...
	function _getProviderAddButton2() {
	  ...
	  const company = babelHelpers.classPrivateFieldLooseBase(this, _getCompanyById)[_getCompanyById]((_babelHelpers$classPr3 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company]) == null ? void 0 : _babelHelpers$classPr3.id);
	...
	function _updateProviderMenu2() {
	  ...
	  firstItem.select();
	  const nothingToSelect = !(company != null && company.registerUrl) && (company == null ? void 0 : (_company$providers = company.providers) == null ? void 0 : _company$providers.length) < 2;
	...
	function _onCompanySelectedHandler2(event) {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _selectCompany)[_selectCompany](selectedItem == null ? void 0 : selectedItem.id);
	}
	function _selectCompany2(id) {
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].id = company.id;
	  babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].provider = null;
	  if ((company == null ? void 0 : (_company$providers2 = company.providers) == null ? void 0 : _company$providers2.length) > 0) {
	    var _company$providers$fi, _company$providers3;
	    const filteredProviders = (_company$providers$fi = (_company$providers3 = company.providers) == null ? void 0 : _company$providers3.filter(provider => allowedSignatureProviders.includes(provider.code))) != null ? _company$providers$fi : [];
	...
	function _refreshView2() {
	  ...
	  const selectedItem = babelHelpers.classPrivateFieldLooseBase(this, _getCompanyById)[_getCompanyById]((_babelHelpers$classPr5 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company]) == null ? void 0 : _babelHelpers$classPr5.id);
	  if (!selectedItem) {
	    return;
	  }
	...
	function _toggleProviderState2(rqInn) {
	  var _babelHelpers$classPr6, _company$providers4;
	  ...
	  if ((company == null ? void 0 : (_company$providers4 = company.providers) == null ? void 0 : _company$providers4.length) > 0) {
	    ...
	    if (babelHelpers.classPrivateFieldLooseBase(this, _options)[_options].region === 'ru') {
	...
	function _openProvidersConnectionSlider2() {
	  ...
	  const company = babelHelpers.classPrivateFieldLooseBase(this, _getCompanyById)[_getCompanyById]((_babelHelpers$classPr7 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company]) == null ? void 0 : _babelHelpers$classPr7.id);
	...
	async function _disconnectCurrentProvider2() {
	  ...
	  const company = babelHelpers.classPrivateFieldLooseBase(this, _getCompanyById)[_getCompanyById]((_babelHelpers$classPr8 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].id) != null ? _babelHelpers$classPr8 : 0);
	  if (!company) {
	    return;
	  }
	  ...
	  babelHelpers.classPrivateFieldLooseBase(this, _hideLoader)[_hideLoader]();
	  babelHelpers.classPrivateFieldLooseBase(this, _selectCompany)[_selectCompany](company.id);
	}
	...
	function _subscribeIframeConnectedEvent2(allowedOrigin) {
	  ...
	  window.addEventListener('message', event => {
	    if (event.origin === allowedOrigin && event.data === 'Event:b2e-crossorigin:connected') {
	      ...
	      const company = babelHelpers.classPrivateFieldLooseBase(this, _getCompanyById)[_getCompanyById]((_babelHelpers$classPr9 = babelHelpers.classPrivateFieldLooseBase(this, _company)[_company].id) != null ? _babelHelpers$classPr9 : 0);
	      if (company) {
	...
	function _getEntityAvatar2(provider) {
	  ...
	  } else if (provider.code === ProviderCode.external && main_core.Type.isStringFilled(provider.iconUrl)) {
	...
	function _setProviderImage2(provider) {
	  ...
	  const img = (_babelHelpers$classPr10 = (_babelHelpers$classPr11 = babelHelpers.classPrivateFieldLooseBase(this, _ui)[_ui].provider.container) == null ? void 0 : _babelHelpers$classPr11.getElementsByClassName(imgClassName)[0]) != null ? _babelHelpers$classPr10 : null;
	  if (!img) {
	    return;
	  }
