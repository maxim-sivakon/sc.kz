...
$MESS['TASK_ELAPSED_TIME_FIELD_USER_NAME'] = "Имя автора записи";
$MESS['TASK_ELAPSED_TIME_FIELD_USER'] = "ID и имя автора записи";
$MESS['TASK_ELAPSED_TIME_FIELD_USER_FULL'] = "Идентификатор и имя автора записи в истории задачи";
$MESS['TASK_ELAPSED_TIME_FIELD_DATE_START'] = "Дата начала работы над задачей";
