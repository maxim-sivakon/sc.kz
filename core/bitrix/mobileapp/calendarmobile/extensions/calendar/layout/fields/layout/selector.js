...
jn.define('calendar/layout/fields/layout/selector', (require, exports, module) => {
			...
			return View(
				{
					style: {
						...
						paddingVertical: 14,
						borderRadius: 8,
						backgroundColor: isChecked ? AppTheme.colors.accentSoftBlue2 : AppTheme.colors.base8,
					},
					clickable: true,
			...
			return View(
				{
					style: {
						width: 12,
						height: 10,
						backgroundImageSvg: icons.check,
					},
				},
			);
		}
	...
	const icons = {
		check: '<svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M1.36008 3.89341L4.0133 6.54663L10.3161 0.447021L11.6761 1.8071L5.37656 7.90671L4.0133 9.26679L2.65321 7.90671L0 5.2535L1.36008 3.89341Z" fill="#00A2E8"/> </svg>',
