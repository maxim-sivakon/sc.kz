...
<? $APPLICATION->IncludeComponent("bitrix:catalog", "catalog", [
	...
	// Включить сохранение информации о просмотре товара на детальной странице для старых шаблонов
	...
	"TOP_OFFERS_FIELD_CODE"                        => [    // Поля предложений
		0 => "",
		1 => "",
	],
